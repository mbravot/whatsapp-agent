...
Simula una conversación en la terminal como si fueras un cliente interno de La Hornilla.
"""
...
async def main():
    ...
    print()
    print("=" * 55)
    print("   AgentKit — SofIA (La Hornilla) — Test Local")
    print("=" * 55)
    print()
    print("  Escribe mensajes como si fueras un colaborador interno.")
